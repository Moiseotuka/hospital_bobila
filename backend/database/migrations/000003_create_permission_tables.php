...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not loaded. Run php artisan permission:cache');
        }
    ...
    public function down(): void
    {
        $tableNames = config('permission.table_names');
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not found. Please run php artisan permission:cache');
        }
